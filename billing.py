...
class Bill_App:
    def __init__(self,root):
        ...
        self.Shirt=["Tommy Hilfiger","Peter England","Allen Solly Shirt"]
        self.price_TommyHilfiger=1000
        self.price_PeterEngland=1200
        self.price_AllenSollyShirt=1400

        self.Jeans=["Levis Jeans","Wrangler","Lee"]
        self.price_LevisJeans=3000
        self.price_Wrangler=2800
        self.price_Lee=2500

        self.Jacket=["Denim","Allen Solly","Roadster Jacket"]
        self.price_Denim=6000
        self.price_AllenSolly=4800
        self.price_RoadsterJacket=3500

        self.Undergarments=["Calvein","Rupa","LUX"]
        self.price_Calvein=500
        self.price_Rupa=100
        self.price_LUX=200

        self.Suit=["Emporio Armani","Blackberry","Bunaai"]
        self.price_EmporioArmani=15000
        self.price_Blackberry=18000
        self.price_Bunaai=20000

        self.Kurta=["Manyavar","Jompers","Sojanya"]
        self.price_Manyavar=2300
        self.price_Jompers=2300
        self.price_Sojanya=1900

        self.Blanket=["Signature","Black Magic","HUESLAND"]
        self.price_Signature=10000
        self.price_BlackMagic=5800
        self.price_HUESLAND=9760

        #Sub Category Households list
        self.SubcategoryHouseholds=["Kitchen item","Cleaning item","kids item"]
        self.Kitchenitem=["Oil","Salt","Milk","Vinegar","Mustard","Rice","Dal","Lavang","Jeera","Curd","Peppercorn","Saffron","Sugar","Beans","Butter","Sauces","Vegetables","Fruit","Flour","Cashew","Tea leaf","Spices","Aluminum foil","Pots & pans","Utensils","Wheat","MatchStick","Turmeric Powder"]
        self.price_Oil=150
        self.price_Salt=24
        self.price_Milk=20
        ...
        self.Cleaningitem=["Bath wash","Face wash","Surf","Soap","Toilet Cleaner","Tooth paste"]
        ...
        self.kidsitem=["Chocolate","IceCream","Toffee","Pepsi","Chips","Maggie","Cake","Popcorn","Oatmeal","Olives","Bread","Nuts","Ketchup","Biscuits","Namkeen"]
        ...
        self.SubcategoryMobiles=["Iphone","Xiaomi","oneplus","Samsung","Realme","Vivo","Oppo"]
        self.Iphone=["Iphone 11","Iphone SE","Iphone 12","Iphone 12 Mini","Iphone 12 pro","Iphone 13","Iphone 13 Mini","Iphone 13 pro","Iphone X"]
        ...
        self.Xiaomi=["Mi 11 ultra 5g","Mi 11 Pro","Mi 10i","Mi 10 Lite","Mi 10S","Mi 10 Pro","Mi 8 Lite","Mi 6","Mi 5X"]
        ...
        self.oneplus=["oneplus Nord 2 5G","oneplus  Nord CE 5G","oneplus Nord N10 5G","oneplus Nord","oneplus 9 Series","oneplus 8T","oneplus 8 Series","oneplus 7T Pro","oneplus 7 Series"]
        ...
        self.Samsung=["Samsung S20 ultra","Samsung S20 ultra 5G","Samsung M31","Samsung A11","Samsung M21","Samsung A31","Samsung A41"]
        ...
        self.Realme=["Realme C20","Realme Narzo 50A","Realme Narzo 30 Pro","Realme X7","Realme 7","Realme 8","Realme 8i","Realme 8s","Realme GT Neo 2",]
        ...
        self.Vivo=["Vivo X70 Pro Plus","Vivo Y21","Vivo X70 Pro","Vivo Y20","Vivo X60","Vivo V20","Vivo V21","Vivo Y20G","Vivo Y3S",]
        ...
        self.Oppo=["Oppo Reno 6","Oppo A53s","Oppo Reno 6 Pro","Oppo A74","Oppo F19 Pro","Oppo F19s","Oppo F19 Pro plus","Oppo A54","Oppo Reno 3 Pro",]
        ...
        self.SubcategoryElectronics=["TV","Radio","Washing Machine","Freezer","Earphones","Trimmer","Tubelight","Bulb","Monitor","Mouse","Keyboard","Printer","Gyser"]
        self.TV=["Sony","LG","Samsung","Mi","Videocon"]
        ...
        self.Radio=["Revo Radio","Ruark Audio","VQ","Philips Radio","iBELL FM","Panasonic Radio"]
        ...
        self.WashingMachine=["Whirlpool","LG Washing Machine","Samsung Washing Machine","Bosch"]
        self.price_Whirlpool=28990
        self.price_LGWashingMachine=44990
        self.price_SamsungWashingMachine=47000
        self.price_Bosch=38990

        self.Freezer=["Haier","LG Freezer","Bosch Freezer","Summit"]
        self.price_Haier=7499
        self.price_LGFreezer=54990
        self.price_BoschFreezer=39990
        self.price_Summit=29990

        self.Earphones=["Boat","Apple","Samsung Galaxy","JBL","Sony WI","Realme Buds","Boat Rockerz","One Plus blast","Boat Airdopes"]
        ...
        self.Trimmmer=["Havelles","Phillips Beared trimmer series","Goldtech","Syska"]
        self.price_Havelles=1676
        self.price_PhillipsBearedtrimmerseries=1199
        self.price_Goldtech=3705
        self.price_Syska=749

        self.Tubelight=["Everready ","Sony Tubelight","LG Tubelight","Crompton","HALCO","Phillips Tubelight"]
        ...
        self.Bulb=["Everready Bulb","Sony Bulb","LG Bulb","Crompton Bulb","HALCO Bulb","Phillips Bulb"]
        ...
        self.Monitor=["HP","Dell","Acer","Asus","Lenovo","Apple Monitor","LG Monitor","Samsung Monitor"]
        self.price_HP=45999
        ...
        self.Mouse=["HP Mouse","Dell Mouse","Acer Mouse","Asus Mouse","Lenovo Mouse"]
        ...
        self.Keyboard=["HP Keyboard","Dell Keyboard","Acer Keyboard","Asus Keyboard","Lenovo Keyboard"]
        ...
        self.Printer=["HP Printer","Dell Printer","Acer Printer","Asus Printer","Lenovo Printer"]
        ...
        self.Gyser=["Bajaj","Venus","Usha","Morphy Richards"]
        ...
        self.Combo_subcategory.grid(row=1,column=1,stick=W,padx=4,pady=2)
